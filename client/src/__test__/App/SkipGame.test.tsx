...
describe('Test suite for component SkipGame', () => {
    ...
    test('SkipGame component should use props makeWinnerAler and chooseRandomNewGame', () => {
        ...
        ReactDOM.render(<SkipGame makeWinnerAlert={makeWinnerAlertMock} chooseRandomNewGame={chooseRandomNewGameMock}></SkipGame>, div)
    })

    test('A click on add user button should fire action addUser', () => {
        const { getByTestId } = render(<SkipGame makeWinnerAlert={makeWinnerAlertMock} chooseRandomNewGame={chooseRandomNewGameMock}></SkipGame>)
