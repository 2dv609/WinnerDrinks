...
describe('Test suite for game module party', () => {
  ...
  test('Game module party should use props gameService, gameEvent and currentPlayers', () => {
    ...
    ReactDOM.render(<Party currentPlayers={currentPlayers} gameService={gameServiceMock} gameEvent={partyQuestionMock} />, div)
  })
  ...
  test('T1.MP.UI.2: Game module party should display a party game event', () => {
    const { getByTestId } = render(<Party currentPlayers={currentPlayers} gameService={gameServiceMock} gameEvent={partyQuestionMock} />)
