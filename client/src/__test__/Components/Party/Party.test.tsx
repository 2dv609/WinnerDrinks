...
/* test('Game module should use common interface', () => {
    ...
    ReactDOM.render(<Party gameService={gamePropsMock} gameEvent={gameEventMock}></Party>, div)
})

test('Game module party should display a party game event', () => {
    const { getByTestId } = render(<Party gameService={gamePropsMock} gameEvent={gameEventMock}></Party>)
