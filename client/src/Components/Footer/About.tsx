    ...
    return (
        <div>
          ...
          {authors.map((author, index) => {
                        ...
                        <p>It was built using React, TypeScript, MongoDB, Node.js, Bulma, Docker and Ansible, and deployed in the OpenStack cloud environment.</p>
                        <p>You can find the source code and related documents in our <a target="_blank" rel="noreferrer" href="https://github.com/2dv609/WinnerDrinks">Github repository.</a></p>
